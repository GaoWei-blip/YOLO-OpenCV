...
YOLO::YOLO(Net_config config)
{
	...
	strcpy_s(this->netname, config.netname.c_str());  // copy the contents of netname
	...
	this->net = readNetFromDarknet(config.modelConfiguration, config.modelWeights);  // This is used to load the models trained using the DarkNet framework
